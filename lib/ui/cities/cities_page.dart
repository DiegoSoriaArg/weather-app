...
import 'package:appclimax/ui/cities/add/add_city_page.dart';
import 'package:appclimax/ui/cities/cities_bloc.dart';
import 'package:appclimax/ui/common/header_widget.dart';
import 'package:appclimax/ui/ui_constants.dart';
    ...
    final result = await showDialog(
      ...
      builder: (context) => Center(
        child: AlertDialog(
          ...
          content: Text('Seguro desea eliminar la ciudad ${city.title}?'),
          actions: <Widget>[
            OutlineButton(
              child: Text('NO'),
...
class CityItem extends StatelessWidget {
  ...
  const CityItem({Key key, this.city, this.onTap}) : super(key: key);
